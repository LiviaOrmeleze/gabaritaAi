  ...
  return (
    <div className='bgsaibamais min-vh-100 text-light d-flex flex-column flex-md-row align-items-center justify-content-between overflow-hidden'>
      ...
      <div className='col-12 col-md-5 ms-md-5 p-5 text-center text-md-start'>
        ...
        <button className='btnsaibamais rounded-5 py-3 px-5 text-uppercase border-0 text-light mt-3 botaosaibamais font-open-sans-bold w-75 w-md-50' onClick={() => window.location.href = '/conhecanossosite'}>
          Saiba mais
        </button>
      </div>
