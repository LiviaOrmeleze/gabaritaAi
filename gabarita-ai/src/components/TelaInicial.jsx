...
const TelaInicial = ({ onStartTest, questions, subjectInfo, levelDefinitions }) => {
    ...
    >
      <div className="card shadow-lg" style={{ maxWidth: "800px", width: "100%" }}>
        <div className="card-header text-center bg-primary text-white">
          <div className="mb-3">
            <img src="/raposa.png" alt="Raposa" className="img-fluid" style={{ width: "80px", height: "80px" }} />
          </div>
        ...
        <div className="card-body">
          <div className="alert alert-info mb-4">
            ...
            <ul className="mb-0 small">
              ...
              <li>
                Os níveis são: Iniciante, Básico, Intermediário Inicial, Intermediário, Intermediário Avançado, Avançado
                e Especialista
              </li>
            </ul>
          </div>
          ...
          <button onClick={onStartTest} className="btn btn-primary btn-lg w-100">
            Iniciar Teste
          </button>
        </div>
      </div>
